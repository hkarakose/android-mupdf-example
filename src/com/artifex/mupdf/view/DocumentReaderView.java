...
//				}
        ...
        PdfView displayedView = (PdfView) getDisplayedView();
        displayedView.play();
...
//				Intent intent = new Intent(getContext(), SlideShowActivity.class); halil
...
//				intent.putExtra("uri", linkString);
			...
			//WebViewActivity.startWithUrl(getContext(), uri.toString());  halil
		}
